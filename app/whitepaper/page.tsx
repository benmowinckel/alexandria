...
const DESCRIPTION =
  'the full argument: what ai leaves for humans, where humans still get paid, and the practice that develops the part that wins — so every ai thinks with you, not for you.';
