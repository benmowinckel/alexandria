...
const installCmd = () => `I want to start a private, local Alexandria loop: files on my machine and local hooks that save our conversations when my AI tool allows it, so you can remember them, learn how I think, and help me develop. It also adds one small \`/a\` reminder after completed tasks, which I can turn off.
