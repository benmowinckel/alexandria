...
Two questions decide the next century. When a machine can do everything humans do, and do it better, what is left for humans to do? And even if humans still do something — how does that human remain that human once the machine becomes the most persuasive voice in one life?
