...
assert.match(page, /open your library/);
assert.match(page, /continue here in your browser/);
...
assert.match(pageWithCode, /connect your website/);
assert.match(pageWithCode, /open your library/);
assert.match(pageWithCode, /continue here in your browser/);
