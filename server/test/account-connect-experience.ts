...
assert.match(connector, /when a person matters, your ai can now use only what that person allowed you to read/);
assert.match(connector, /permissions\/people-context/);
...
assert.doesNotMatch(connector, /shared intelligence/i);
