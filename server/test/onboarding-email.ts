...
assert.match(mobile, /If reminders work/);
...
assert.match(mobile, /invoke this host's alexandria skill in a new chat if you can/);
assert.match(mobile, /If you cannot, name its exact skill gesture/);
