...
- **Needs:** the two healthy-loop markers named in `factory/connect.md`, an active membership, and the one-use handoff supplied during the initial join or created later by an already-connected loop.
