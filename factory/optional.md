...
- **Needs:** the two healthy-loop markers named in `factory/connect.md`, an active membership, and a one-use handoff created by an already-connected loop after the Author asks.
