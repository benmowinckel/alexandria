...
**Shape: five dimensions × 1 entry per dimension.** Same five operation crafts as the morning brief (Genesis / Accretion / Entropy / Development / Creation), surfaced as a menu the Author scans and engages from. The structural reminder — all five dimensions present, all equally important — is the point; the Author can't always remember they all exist, and the menu IS the reminder. The Engine's strongest single move goes in under whichever dimension it lives in; the other four dimensions still surface their own picks, ensuring no dimension fades.
