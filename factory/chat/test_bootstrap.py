...
class ChatBootstrapTests(unittest.TestCase):
    ...
    def test_local_installer_keeps_memory_and_adds_exact_folder(self) -> None:
        ...
        self.assertIn("this setup sent no personal record to Alexandria and connected no account", block)
        self.assertIn("approved material read into a hosted AI's context is processed by that provider", block)
