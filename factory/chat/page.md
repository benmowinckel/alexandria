...
On `/start`, choosing `just chat` copies the setup immediately and changes the page to `copied — paste into your chat`. A direct `/chat` visit keeps the equivalent `copy the setup — paste into your chat` button.
