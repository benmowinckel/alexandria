...
On `/start`, choosing `just chat` copies the setup immediately, changes that same line to `copied — paste into your chat`, and quietly removes the agent choice. A direct `/chat` visit keeps the equivalent `copy the setup — paste into your chat` button.
