...
*Master content for the `_start` Google Doc the bootstrap creates in the Author's Drive. Format constraint (verified 2026-07-23): no code fences, no tables — markdown→Doc conversion destroys fences and degrades tables through the connector's reader. Headings, lists, bold, links only.*
